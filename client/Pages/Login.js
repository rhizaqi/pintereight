...
import { View, Image, TextInput, Text, Button, ActivityIndicator } from "react-native";
    ...
    <View style={{ flex: 1 }}>
      <View style={{ padding: 10, backgroundColor: "gray", flex: 1 }}>
        ...
        <View style={{ flex: 2, alignItems: "center" }}>
          ...
          <Text style={{marginTop:5, marginBottom:5}}>You have not accound? Register 
            <Text onPress={navigateRegister}
             style={{color:"blue", fontSize:16}}> here </Text>  
          </Text>
